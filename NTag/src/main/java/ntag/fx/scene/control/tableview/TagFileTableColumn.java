...
public class TagFileTableColumn extends TableColumn<Object, Object> {
	...
	public enum ColumnType {
		...
		ROW(30, "row", null), //
		STATUS(50, "status", StatusTableCell.class), //
		FILENAME(200, "name", null), //
		...
		PLAYTIME(50, "playtime", PlaytimeTableCell.class), //
		SIZE(60, "size", FileSizeTableCell.class), //
		FORMAT(100, "audioFormat", null), //
		BITRATE(80, "bitrate", BitrateTableCell.class), //
		VBR(40, "vbr", BooleanTableCell.class), //
		CREATED(120, "created", LocalDateTimeTableCell.class), //
		MODIFIED(120, "modified", LocalDateTimeTableCell.class);
