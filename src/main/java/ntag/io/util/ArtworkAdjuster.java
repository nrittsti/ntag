...
public class ArtworkAdjuster {
  ...
  public ArtworkAdjuster() {
    ...
    enforceImageType = NTagProperties.instance().isArtworkEnforceImageFormat();
    maxResolution = NTagProperties.instance().getArtworkMaxResolution();
    maxKilobytes = NTagProperties.instance().getArtworkMaxKilobytes();
    quality = NTagProperties.instance().getArtworkQuality();
  }
