...
public class RatingControl extends Control {
  ...
  private final ObjectProperty<Integer> valueProp = new SimpleObjectProperty<>(this, "value", 0);
  ...
  private final ObjectProperty<Integer> ratingProp = new SimpleObjectProperty<>(this, "rating", 0);
  ...
  private final ObjectProperty<Integer> hoverValueProp = new SimpleObjectProperty<>(this, "hoverValueProp", 0);
  ...
  public RatingControl() {
    ...
    valueProp.addListener((ObservableValue<? extends Number> observable, Number oldValue, Number newValue) -> setHoverValue(getValue()));
    hoverValueProp.addListener((ObservableValue<? extends Number> observable, Number oldValue, Number newValue) -> updateStars());
  ...
  private int calcSelection(MouseEvent event) {
    ...
    if (value < 15) {
      ...
      value = Math.min(value, RatingControl.MAXIMUM);
    }
    return value;
  }
}
