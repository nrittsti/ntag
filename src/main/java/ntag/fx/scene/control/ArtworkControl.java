...
public class ArtworkControl extends HBox implements Initializable {
  ...
  private final ObjectProperty<EventHandler<ActionEvent>> clearEventHandlerProp = new SimpleObjectProperty<>(this, "clearEventHandler", null);
  ...
  private final ObjectProperty<ArtworkTag> artworkProp = new SimpleObjectProperty<>(this, "artwork", null);
  ...
  private final StringProperty tooltipProp = new SimpleStringProperty(this, "");
