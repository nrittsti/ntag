...
public class EditorProperty<T> {
  ...
  private static final ObservableList<TagFile> changedObjects = FXCollections.observableArrayList();
  ...
  private final ObjectProperty<T> valueProp = new SimpleObjectProperty<>(this, "value", null);
  ...
  private final StringProperty styleProp = new SimpleStringProperty(this, "");
  ...
  private final BooleanProperty differentProp = new SimpleBooleanProperty(this, "different", false);
  ...
  private final ObjectProperty<Tooltip> tooltipProp = new SimpleObjectProperty<>(this, null);
