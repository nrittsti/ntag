...
public class ArtworkEditorProperty extends EditorProperty<ArtworkTag> {
  ...
  private final static EmptyCheck<ArtworkTag> emptyArtworkCheck = (ArtworkTag value) -> value == null || value.getImageData() == null;
  ...
  public ArtworkEditorProperty() throws SecurityException {
    super("artwork", emptyArtworkCheck);
    setTooltip(new Tooltip(""));
    valueProperty().addListener((ObservableValue<? extends ArtworkTag> observable,
                                 ArtworkTag oldValue,
                                 ArtworkTag newValue) -> createTooltip(newValue));
  }
